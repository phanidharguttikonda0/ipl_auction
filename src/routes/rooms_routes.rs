...
pub fn rooms_routes() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/get-auctions-played/{page_number}/{per_page}", get(get_rooms_played)) // it going to return the list of room-ids participated by the user and along with date
