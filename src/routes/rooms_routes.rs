...
pub fn rooms_routes() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/get-participants", get(get_participants_room)) // it going to return the list of participants-id along with the team-name, using these participant_ids to get the team details and player details
